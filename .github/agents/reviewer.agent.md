...
### ドキュメントレビュー（ISO29148/IEEE1016準拠）
...
| 観点 | 評価基準 |
|------|----------|
| 網羅性 | 仕様のすべての要件がテストされているか |
| テスト技法 | 適切なテスト技法が使用されているか |
| 境界値 | 境界値が考慮されているか |
| 異常系 | エラーケースが含まれているか |
| 独立性 | テスト間の依存がないか |
| 再現性 | テストが安定して再現可能か |
...
| カテゴリ | チェック項目 |
|----------|-------------|
| A01:2021 アクセス制御の不備 | 認可チェックが適切か |
| A02:2021 暗号化の失敗 | 機密データが適切に保護されているか |
| A03:2021 インジェクション | SQLインジェクション、XSS対策 |
| A04:2021 安全でない設計 | セキュリティを考慮した設計か |
| A05:2021 セキュリティ設定のミス | デフォルト設定が安全か |
| A06:2021 脆弱なコンポーネント | 既知の脆弱性がないか |
| A07:2021 認証の失敗 | 認証機構が適切か |
| A08:2021 ソフトウェアとデータの整合性の不備 | 入力検証が適切か |
| A09:2021 セキュリティログとモニタリングの不備 | ログが適切か |
| A10:2021 SSRF | 外部リソースへのアクセス制御 |
