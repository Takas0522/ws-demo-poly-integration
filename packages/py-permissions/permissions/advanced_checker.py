...
from .types import User, TenantUser
from .parser import matches_wildcard
...
class PermissionChecker:
    ...
    def __init__(
        ...
        get_tenant_user_from_db: Optional[Callable[[str, str], Awaitable[Optional[Dict[str, Any]]]]] = None
    ):
